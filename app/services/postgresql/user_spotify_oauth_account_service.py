...
class UserSpotifyOAuthAccountService:
    ...
    async def add_new_user_with_spotify_oauth_account(self, session: AsyncSession, provider_user_id: str, subscription: str, encrypted_access_token: str, encrypted_refresh_token: str, access_token_expires_in_seconds: datetime):
        ...
        oauth_account = UserSpotifyOauthAccount(
            ...
            subscription=subscription if subscription in ["premium", "free"] else "free",
    ...
    async def add_spotify_oauth_account_to_existing_user(self, session: AsyncSession, user_id: int, provider_user_id: str, subscription: str, encrypted_access_token: str, encrypted_refresh_token: str, access_token_expires_in_seconds: datetime):
    ...
    async def update_oauth_tokens(self, session: AsyncSession, user_id: int, subscription: str, encrypted_access_token: str, expires_in_seconds: datetime, encrypted_refresh_token: str = None):
        ...
        user_spotify_oauth_account.subscription = subscription if subscription in ["premium", "free"] else "free"
